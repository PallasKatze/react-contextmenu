...
var SubMenu = function (_AbstractMenu) {
    ...
    function SubMenu(props) {
        ...
        _this.getHorizontalPosition = function (menuRect, areaRect) {
            var _window = window,
            ...
            if (areaRect.right > innerWidth) {
                // Clamp
                if (areaRect.left < 0) {
                    return _this.limitHorizontally(menuRect, areaRect);
                }
        ...
        _this.limitHorizontally = function (menuRect, areaRect) {
            var _window2 = window,
        ...
        _this.limitVertically = function (menuRect, areaRect) {
            var _window3 = window,
        ...
        _this.getRTLHorizontalPosition = function (menuRect, areaRect) {
            var _window4 = window,
                innerWidth = _window4.innerWidth;
        ...
        _this.getMenuPosition = function () {
            var _window5 = window,
                innerHeight = _window5.innerHeight;
            ...
            position = Object.assign(position, _this['get' + (rtl ? 'RTL' : '') + 'HorizontalPosition'](menuRect, areaRect));
